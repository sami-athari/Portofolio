...
const EmailSection = () => {
  ...
  return (
    <section id="contact" className="grid md:grid-cols-2 my-12 py-24 px-8">
      <div className="flex flex-col justify-center items-start text-white pl-[50px]"> {/* Added pl-4 for left padding */}
        <h5 className="text-xl font-bold mb-4">Let`s Connect</h5>
        <p className="text-[#ADB7BE] mb-6 max-w-md">
          I&apos;m currently looking for new opportunities. Whether you have a question or just want to say hi, I&apos;ll try my best to get back to you!
        </p>
      </div>
      <div className="relative w-full max-w-md mx-auto p-6 border-none rounded-lg shadow-md form-container">
        ...
        <div className="w-full max-w-md mx-auto p-6 bg-[#232427] border border-[#33353F] rounded-lg shadow-md relative z-10">
          {emailSubmitted ? (
            ...
            <form className="flex flex-col" onSubmit={handleSubmit}>
              ...
              <button type="submit" className="bg-zinc-600 hover:bg-zinc-700 text-white font-medium py-2.5 px-5 rounded-lg w-full">
                Send Message
              </button>
            </form>
          )}
